...
def setup_preprocessor():
    ...
    numerical_cols = [
        'Flow Packets/s', 'Bwd Packets/s', 'Flow Duration', 'Flow Bytes/s', 'Fwd IAT Std', 'Idle Std',
        'Packet Length Std', 'Fwd Packet Length Std', 'Average Packet Size', 'Active Std', 'Active Max',
        'Bwd IAT Max', 'Bwd Packet Length Min', 'Bwd Packet Length Max', 'Fwd Seg Size Min',
        'Subflow Fwd Packets', 'Subflow Bwd Packets', 'Bwd Init Win Bytes', 'FWD Init Win Bytes',
        'Subflow Bwd Bytes', 'Subflow Fwd Bytes', 'Bwd Bulk Rate Avg', 'ACK Flag Count'
    ]
